...
class AC_Multi_Kernal(nn.Module):
    def __init__(self, in_channels, out_channels, M=3, G=8, stride=1):
        ...
        """
        super(AC_Multi_Kernal, self).__init__()
        ...
        for i in range(M):
            self.convs.append(ACBlock(in_channels, out_channels, kernel_size=3 + i * 2, stride=stride, groups=G))
