...
from models.efficientnet_base.SE_efficientnet import SE_EfficientNet
from models.efficientnet_base.CBAM_efficientnet import CBAM_EfficientNet
...
def _stanfordDogs():
    ...
    model = Net(CBAM_EfficientNet.from_pretrained('efficientnet-b4'), 120)
    model.to(device)
